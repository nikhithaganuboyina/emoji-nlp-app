...
templates = {
    ...
    "😂": ["That was funny", "LOL", "Hilarious!", "I can't stop laughing", "So funny!"],
    ...
    "🤤": ["Hungry", "I want that", "So tempting", "Delicious food", "Mouth watering", "I am starving", "I need food"],
    ...
    "😴": ["Sleeping", "Good night", "Dreaming", "Feeling relaxed", "ZZZ..."],
